          ...
          <wizard-page title="Categorize" icon="suitcase" :valid="valid.category">
            <form data-vv-scope="category">
              <div class="form-group">
                ...
                <select v-model="page.category" class="form-control" v-validate data-vv-rules="required" @change="validate('category')">
              ...
              <div class="form-group" v-if="page.category != null">
                ...
                <select v-model="page.branch" class="form-control" v-validate data-vv-rules="required" @change="validate('category')">
