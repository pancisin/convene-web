    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="text-center">
          <h3 class="font-600">Privacy policy</h3>
      ...
      <div class="col-lg-9 center-page">
        ...
        <p>
          ...
          <br/>
          <br/> You may opt out of any future contacts from us at any time. You can do the following at any time by contacting us via the email address or phone number provided on our website:
        </p>
        <ul>
          <li>
